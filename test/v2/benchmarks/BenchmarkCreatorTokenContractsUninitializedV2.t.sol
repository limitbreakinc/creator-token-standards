...
// | isTransferAllowed                | 6988            | 15062 | 15111  | 23454 |
// | isTransferAllowed                | 8936            | 17010 | 17059  | 25402 |
// | isTransferAllowed                | 6922            | 14996 | 15045  | 23388 |
// | isTransferAllowed                | 6992            | 15066 | 15115  | 23458 |

contract BenchmarkCreatorTokenContractsUninitializedV2 is Test {
    ...
    // 3313 gas (1 SLOAD)
    function testBenchmarkTokenUninitializedV2LevelZero(address caller, address from, address to) public {
    ...
    // 3262 gas (1 SLOAD)
    function testBenchmarkTokenUninitializedV2LevelOneOTC(address tokenOwner, address to) public {
    ...
    // 10375 gas (3 SLOADS)
    function testBenchmarkTokenUninitializedV2LevelOneNonOTC(address caller, address from, address to) public {
        vm.assume(caller != address(0));
        vm.assume(caller != address(blacklistedOperatorMock));
        vm.assume(caller != address(blacklistedOperatorMock1));
        vm.assume(caller != address(blacklistedOperatorMock2));
    ...
    // 3311 gas (1 SLOAD)
    function testBenchmarkTokenUninitializedV2LevelTwoOTC(address tokenOwner, address to) public {
        vm.assume(tokenOwner != address(0));
    ...
    // 5567 Gas (2 SLOADS)
    function testBenchmarkTokenUninitializedV2LevelTwoNonOTCOperatorAccountWhitelisted(address from, address to) public {
        vm.assume(from != address(0));
    ...
    // 10374 gas (3 SLOADS)
    function testBenchmarkTokenUninitializedV2LevelTwoNonOTCOperatorCodeHashWhitelisted(address from, address to) public {
        vm.assume(from != address(0));
    ...
    // 5724 gas (2 SLOADS)
    function testBenchmarkTokenUninitializedV2LevelThreeOTCOwnerIsWhitelistedAccount(address to) public {
        vm.assume(to != address(0));
        vm.assume(to.code.length == 0);
    ...
    function testBenchmarkTokenUninitializedV2LevelThreeOTCOwnerIsWhitelistedCodehash(address to) public {
        vm.assume(to != address(0));
        vm.assume(to.code.length == 0);
    ...
    // 5676 gas (2 SLOADS)
    function testBenchmarkTokenUninitializedV2LevelThreeNonOTCOperatorIsWhitelistedAccount(address from, address to) public {
        vm.assume(from != address(0));
    ...
    // 7880 gas (3 SLOADS)
    function testBenchmarkTokenUninitializedV2LevelThreeNonOTCOwnerIsWhitelistedAccount(address caller, address to) public {
        vm.assume(caller != address(0));
    ...
    // 12698 gas (4 SLOADS)
    function testBenchmarkTokenUninitializedV2LevelThreeNonOTCOperatorIsWhitelistedCodeHash(address from, address to) public {
        vm.assume(from != address(0));
        vm.assume(from.code.length == 0);
        vm.assume(to != address(0));
        vm.assume(to.code.length == 0);
    ...
    // 15002 gas (5 SLOADS)
    function testBenchmarkTokenUninitializedV2LevelThreeNonOTCOwnerIsWhitelistedCodeHash(address caller, address to) public {
        vm.assume(caller != address(0));
        vm.assume(caller.code.length == 0);
        vm.assume(to != address(0));
        vm.assume(to.code.length == 0);
    ...
    // 8200 gas (2 SLOADS)
    function testBenchmarkTokenUninitializedV2LevelFourOTCWhitelistedToAddress(address tokenOwner) public {
        vm.assume(tokenOwner != address(0));
        vm.assume(tokenOwner != address(whitelistedOperatorMock));
        vm.assume(tokenOwner != address(whitelistedOperatorMock1));
        vm.assume(tokenOwner != address(whitelistedOperatorMock2));
    ...
    // 10503 gas (3 SLOADS)
    function testBenchmarkTokenUninitializedV2LevelFourOTCWhitelistedToCodeHash(address tokenOwner) public {
        vm.assume(tokenOwner != address(0));
        vm.assume(tokenOwner != address(whitelistedOperatorMock));
        vm.assume(tokenOwner != address(whitelistedOperatorMock1));
        vm.assume(tokenOwner != address(whitelistedOperatorMock2));
    ...
    // 3497 gas (1 SLOAD)
    function testBenchmarkTokenUninitializedV2LevelFourOTCWhitelistedToHasNoCode(address tokenOwner, address to) public {
        vm.assume(tokenOwner != address(0));
        vm.assume(tokenOwner != address(whitelistedOperatorMock));
        vm.assume(tokenOwner != address(whitelistedOperatorMock1));
        vm.assume(tokenOwner != address(whitelistedOperatorMock2));
    ...
    // 15263 gas (4 SLOADS)
    function testBenchmarkTokenUninitializedV2LevelFourNonOTCWhitelistedToAddress(address from) public {
        vm.assume(from != address(0));
    ...
    // 12759 (4 SLOADS)
    function testBenchmarkTokenUninitializedV2LevelFourNonOTCWhitelistedToCodeHash(address from) public {
        vm.assume(from != address(0));
        vm.assume(from != address(whitelistedOperatorMock));
        vm.assume(from != address(whitelistedOperatorMock1));
        vm.assume(from != address(whitelistedOperatorMock2));
    ...
    // 5753 (2 SLOADS)
    function testBenchmarkTokenUninitializedV2LevelFourNonOTCWhitelistedToHasNoCode(address from, address to) public {
        vm.assume(from != address(0));
        vm.assume(from != address(whitelistedOperatorMock));
        vm.assume(from != address(whitelistedOperatorMock1));
        vm.assume(from != address(whitelistedOperatorMock2));
    ...
    // 7861 gas (3 SLOADS)
    function testBenchmarkTokenUninitializedV2LevelFiveOTCWhitelistedToAddress(address tokenOwner) public {
        vm.assume(tokenOwner != address(0));
        vm.assume(tokenOwner != address(whitelistedOperatorMock));
        vm.assume(tokenOwner != address(whitelistedOperatorMock1));
        vm.assume(tokenOwner != address(whitelistedOperatorMock2));
    ...
    // 12664 gas (4 SLOADS)
    function testBenchmarkTokenUninitializedV2LevelFiveOTCWhitelistedToCodeHash(address tokenOwner) public {
        vm.assume(tokenOwner != address(0));
        vm.assume(tokenOwner != address(whitelistedOperatorMock));
        vm.assume(tokenOwner != address(whitelistedOperatorMock1));
        vm.assume(tokenOwner != address(whitelistedOperatorMock2));
    ...
    // 3658 gas (2 SLOADS)
    function testBenchmarkTokenUninitializedV2LevelFiveOTCWhitelistedToHasNoCode(address tokenOwner, uint160 toKey) public {
    ...
    // 14924 gas (5 SLOADS)
    function testBenchmarkTokenUninitializedV2LevelFiveNonOTCWhitelistedToAddress(address from) public {
        vm.assume(from != address(0));
        vm.assume(from != address(whitelistedOperatorMock));
        vm.assume(from != address(whitelistedOperatorMock1));
        vm.assume(from != address(whitelistedOperatorMock2));
    ...
    // 14920 (5 SLOADS)
    function testBenchmarkTokenUninitializedV2LevelFiveNonOTCWhitelistedToCodeHash(address from) public {
        vm.assume(from != address(0));
        vm.assume(from != address(whitelistedOperatorMock));
        vm.assume(from != address(whitelistedOperatorMock1));
        vm.assume(from != address(whitelistedOperatorMock2));
    ...
    // 5914 gas (3 SLOADS)
    function testBenchmarkTokenUninitializedV2LevelFiveNonOTCWhitelistedToHasNoCode(address from, uint160 toKey) public {
        address to = _verifyEOA(toKey);
    ...
    // 17636 gas (5 SLOADS)
    function testBenchmarkTokenUninitializedV2LevelSixNonOTCWhitelistedToAddress(address from) public {
        vm.assume(from != address(0));
        vm.assume(from != address(whitelistedOperatorMock));
        vm.assume(from != address(whitelistedOperatorMock1));
        vm.assume(from != address(whitelistedOperatorMock2));
    ...
    // 12917 gas (4 SLOADS)
    function testBenchmarkTokenUninitializedV2LevelSixNonOTCWhitelistedToCodeHash(address from) public {
        vm.assume(from != address(0));
        vm.assume(from != address(whitelistedOperatorMock));
        vm.assume(from != address(whitelistedOperatorMock1));
        vm.assume(from != address(whitelistedOperatorMock2));
    ...
    // 5911 gas (2 SLOADS)
    function testBenchmarkTokenUninitializedV2LevelSixNonOTCWhitelistedToHasNoCode(address from, address to) public {
        vm.assume(from != address(0));
        vm.assume(from != address(whitelistedOperatorMock));
        vm.assume(from != address(whitelistedOperatorMock1));
        vm.assume(from != address(whitelistedOperatorMock2));
    ...
    // 17249 gas (6 SLOADS)
    function testBenchmarkTokenUninitializedV2LevelSevenNonOTCWhitelistedToAddress(address from) public {
        vm.assume(from != address(0));
        vm.assume(from != address(whitelistedOperatorMock));
        vm.assume(from != address(whitelistedOperatorMock1));
        vm.assume(from != address(whitelistedOperatorMock2));
    ...
    // 15030 gas (5 SLOADS)
    function testBenchmarkTokenUninitializedV2LevelSevenNonOTCWhitelistedToCodeHash(address from) public {
        vm.assume(from != address(0));
        vm.assume(from != address(whitelistedOperatorMock));
        vm.assume(from != address(whitelistedOperatorMock1));
        vm.assume(from != address(whitelistedOperatorMock2));
    ...
    // 6024 gas (3 SLOADS)
    function testBenchmarkTokenUninitializedV2LevelSevenNonOTCWhitelistedToHasNoCode(address from, uint160 toKey) public {
        address to = _verifyEOA(toKey);
