...
import "../../v2/mocks/AdventureMock.sol";
import "../../v2/mocks/AdventureERC721CMock.sol";
...
contract AdventureERC721CV2WithPermitsTest is CreatorTokenTransferValidatorERC721V2WithPermitsTest, AdventureHelper {
    ...
    function testV2AdventureLocksTokens() public {
...
contract AdventureERC721CInitializableWithPermitsTest is AdventureHelper, CreatorTokenTransferValidatorERC721V2WithPermitsTest {
    ClonerMock cloner;
