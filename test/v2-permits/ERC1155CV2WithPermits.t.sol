...
contract ERC1155CV2WithPermitsTest is CreatorTokenTransferValidatorERC1155V2WithPermitsTest {
...
contract ERC1155CV2InitializableWithPermitsTest is CreatorTokenTransferValidatorERC1155V2WithPermitsTest {
    ClonerMock cloner;
    ...
    function testV2RevertsWhenInitializingERC1155Again(string memory uri) public {
        vm.expectRevert(
