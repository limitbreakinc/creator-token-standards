...
import "../../v2/mocks/ERC721CWPermanentMock.sol";
import "../CreatorTokenTransferValidatorERC721V2WithPermits.t.sol";

contract ERC721CWPermanentV2WithPermitsTest is CreatorTokenTransferValidatorERC721V2WithPermitsTest {
    ...
    function testV2CanUnstakeReturnsFalseForStakedTokenIds(address to, uint256 tokenId) public {
    ...
    function testV2WrappingCollectionHoldersCannotUnstakeTokens(address to, uint256 tokenId) public {
        vm.assume(to != address(0));
        vm.assume(to != address(tokenMock));
