...
import "../../v2/mocks/ERC1155CWPermanentMock.sol";
import "../CreatorTokenTransferValidatorERC1155V2WithPermits.t.sol";

contract ERC1155CWPermanentV2WithPermitsTest is CreatorTokenTransferValidatorERC1155V2WithPermitsTest {
    ...
    function testV2CanUnstakeReturnsFalseForPermanentlyStakedTokens(
        address to,
        uint256 tokenId,
        uint256 amount,
    ...
    function testV2WrappingCollectionHoldersCannotUnstakeTokensEvenWithSufficientBalance(
        address to,
        uint256 tokenId,
        uint256 amount,
        uint256 amountToUnstake
    ...
    function testV2SecondaryWrappingCollectionHoldersCannotUnstakeTokens(
        address to,
