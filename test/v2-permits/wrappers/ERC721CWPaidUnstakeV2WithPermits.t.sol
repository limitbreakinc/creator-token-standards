...
import "../../v2/mocks/ERC721CWPaidUnstakeMock.sol";
import "../CreatorTokenTransferValidatorERC721V2WithPermits.t.sol";

contract ERC721CWPaidUnstakeV2WithPermitsTest is CreatorTokenTransferValidatorERC721V2WithPermitsTest {
    ...
    function testV2WrappingCollectionHoldersCannotUnstakeTokensIfStakePriceUnderpaid(address to, uint256 tokenId)
        public
    {
        vm.assume(to != address(0));
        vm.assume(to != address(tokenMock));
    ...
    function testV2WrappingCollectionHoldersCannotUnstakeTokensIfStakePriceOverpaid(address to, uint256 tokenId) public {
        vm.assume(to != address(0));
        vm.assume(to != address(tokenMock));
    ...
    function testV2WrappingCollectionHoldersCanUnstakeTokensIfExactStakePriceIsPaid(address to, uint256 tokenId) public {
        vm.assume(to != address(0));
        vm.assume(to != address(tokenMock));
    ...
    function testV2SecondaryWrappingCollectionHoldersCanUnstakeTokensByPayingStakePrice(
        address to,
