...
import "../../v2/mocks/ERC1155CWPaidUnstakeMock.sol";
import "../CreatorTokenTransferValidatorERC1155V2WithPermits.t.sol";

contract ERC1155CWPaidUnstakeV2WithPermitsTest is CreatorTokenTransferValidatorERC1155V2WithPermitsTest {
    ...
    function testV2WrappingCollectionHoldersCannotUnstakeIfUnstakePriceIsUnderpaid(
        address to,
        uint256 tokenId,
        uint256 amount,
        uint256 amountToUnstake
    ...
    function testV2WrappingCollectionHoldersCannotUnstakeIfUnstakePriceIsOverpaid(
        address to,
        uint256 tokenId,
        uint256 amount,
        uint256 amountToUnstake
    ...
    function testV2WrappingCollectionHoldersCanUnstakeIfExactUnstakePriceIsPaid(
        address to,
        uint256 tokenId,
        uint256 amount,
        uint256 amountToUnstake
