...
import "../../v2/mocks/ERC721CWTimeLockedUnstakeMock.sol";
import "../CreatorTokenTransferValidatorERC721V2WithPermits.t.sol";

contract ERC721CWTimeLockedUnstakeV2WithPermitsTest is CreatorTokenTransferValidatorERC721V2WithPermitsTest {
    ...
    function testV2CanUnstakeReturnsFalseForStakedTokenIdsBeforeTimelockExpiration(
        address to,
        uint256 tokenId,
    ...
    function testV2CanUnstakeReturnsTrueForStakedTokenIdsAfterTimelockExpiration(
        address to,
        uint256 tokenId,
    ...
    function testV2WrappingCollectionHoldersCannotUnstakeTokensBeforeTimeLockExpires(address to, uint256 tokenId)
        public
    {
        vm.assume(to != address(0));
        vm.assume(to != address(tokenMock));
    ...
    function testV2WrappingCollectionHoldersCanUnstakeTokensIfAtExactTimelockExpiration(address to, uint256 tokenId)
        public
    {
        vm.assume(to != address(0));
        vm.assume(to != address(tokenMock));
    ...
    function testV2WrappingCollectionHoldersCanUnstakeTokensAnytimeAfterTimelockExpiration(
        address to,
        uint256 tokenId,
        uint256 secondsPastExpiration
    ) public {
    ...
    function testV2SecondaryWrappingCollectionHoldersCanUnstakeTokensAnytimeAfterTimelockExpiration(
        address to,
    ...
    function testV2RevertsWhenNativeFundsIncludedInUnstake(
        address to,
        uint256 tokenId,
        uint256 secondsPastExpiration,
        uint256 value
